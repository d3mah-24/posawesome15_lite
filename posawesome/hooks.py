...
doc_events = {
    "Sales Invoice": {
        "validate": "posawesome.posawesome.api.sales_invoice.validate",
        "before_submit": "posawesome.posawesome.api.sales_invoice.before_submit",
        "before_cancel": "posawesome.posawesome.api.sales_invoice.before_cancel",
    },
    "Customer": {
