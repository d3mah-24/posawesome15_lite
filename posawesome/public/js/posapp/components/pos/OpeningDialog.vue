...
export default {
  ...
  setup(props) {
    ...
    const get_opening_dialog_data = () => {
      frappe.call({
        method: 'posawesome.posawesome.api.get_opening_dialog_data.get_opening_dialog_data',
        args: {},
        callback: function (r) {
          if (r.message) {
    ...
    const submit_dialog = () => {
      ...
      frappe
        .call('posawesome.posawesome.api.create_opening_voucher.create_opening_voucher', {
