...
const API_MAP = {
  ...
  POS_PROFILE: {
    ...
    GET_CURRENT_PROFILE_LANG:
      "posawesome.posawesome.api.pos_profile.get_current_pos_profile_lang",
  },
  ...
  // TRANSLATIONS APIS(from posapp.js)
  TRANSLATIONS: {
    GET_TRANSLATIONS: "posawesome.posawesome.api.translations.get_translations",
  },
};
