...
def post_customer(
    ...
    Args:
        ...
        referral_code (str): Referral code if applicable
    ...
    try:
        ...
        if hasattr(customer_doc, 'posa_referral_code') and referral_code:
            customer_doc.posa_referral_code = referral_code.strip()
